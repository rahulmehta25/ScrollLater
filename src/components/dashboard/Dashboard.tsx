      ...
      .on(
        ...
        (payload) => {
          ...
          if (payload.eventType === 'INSERT') {
            ...
            setEntries(prev => prev.map(e => e.id === (payload.new as Entry).id ? payload.new as Entry : e));
          } else if (payload.eventType === 'DELETE') {
            setEntries(prev => prev.filter(e => e.id !== (payload.old as Record<string, unknown>).id));
          }
        }
      )
      .subscribe();
