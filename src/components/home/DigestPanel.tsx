  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2.5">
        <div className="p-3.5 bg-paper-muted/70 border border-paper-deep rounded-2xl">
          ...
          <button
            ...
            className="mt-2.5 inline-flex items-center gap-1 text-xs font-medium text-ink underline decoration-paper-deep underline-offset-[0.18em] transition-colors duration-craft hover:decoration-ink"
          >
        ...
        {digestCategories.map((cat) => {
          ...
          return (
            <motion.button
              ...
              className="w-full text-left border border-paper-deep rounded-2xl overflow-hidden cursor-pointer hover:border-ink-faint transition-colors duration-craft bg-paper"
            >
