      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="flex items-center gap-2 px-4 py-3">
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
              <button
                ...
                className="xl:hidden p-1.5 rounded-lg text-violet-600 hover:bg-violet-50 transition-colors"
              ...
              <button
                ...
                className="xl:hidden p-1.5 rounded-lg text-blue-600 hover:bg-blue-50 transition-colors"
          ...
          <div className="lg:hidden px-4 pb-3">
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2.5 text-sm text-gray-500 bg-gray-50 border border-gray-200 rounded-xl"
            >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 pb-24 lg:pb-5">
          {isLoading ? (
            ...
            <div className="max-w-lg mx-auto mt-8 rounded-2xl border border-gray-200 bg-white shadow-sm">
              <EmptyState
                icon={empty.icon}
                title={empty.title}
        ...
        {mobilePanel && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-0 left-0 right-0 max-h-[85vh] bg-white rounded-t-2xl shadow-2xl flex flex-col overflow-hidden"
            >
